    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getMethod().equals("GET")){
                ...
                out.println("<td><input type='text' id='nombre' name='nombre'/></td></tr>");
                out.println("<tr><td>Edad: </td>");
                out.println("<td><input type='number' id='edad' name='edad'/></td></tr>");
                out.println("</table>");
                out.println("<input type='submit' value='Enviar' method='get'/>");
                out.println("</form>");
            }else if(request.getMethod().equalsIgnoreCase("POST")){
                out.println("<p>Te llamas "+request.getParameter("nombre")+"</p>");
                out.println("<p>Tienes "+request.getParameter("edad")+"</p>");
            }
            out.println("</body>");
            out.println("</html>");
        }
